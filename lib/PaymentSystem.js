...
const DEFAULT_CONFIG = {
  ...
  paymentNumbers: {
    wave: {
      name: "Wave Business",
      number: "CI 58 32 12 09",  // Compte Marchand Wave
      merchantId: "M_ci_AGzCkYkPdoan",
      merchantName: "Boutique H",
      ownerName: "DJEBLE HANIEL JEAN HENOC",
      logo: "🟢",
      instructions: "Envoyez l'argent au compte marchand Wave ci-dessus"
    },
    moov: {
      name: "Moov Money",
      number: "0150252467",
