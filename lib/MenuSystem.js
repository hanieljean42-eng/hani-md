...
const CATEGORIES = {
  ...
  espionnage: {
    ...
    accessLevel: 'owner',
    commands: [
      { cmd: 'vv', desc: 'Récupérer une vue unique (réponds au message)', usage: '.vv / .haniel / .mounira (répondre)', example: '.haniel', premium: false, ownerOnly: true },
      { cmd: 'listvv', desc: 'Lister les vues uniques interceptées', usage: '.listvv', example: '.listvv', premium: false, ownerOnly: true },
      { cmd: 'lastvv', desc: 'Récupérer la dernière vue unique interceptée', usage: '.lastvv', example: '.lastvv', premium: false, ownerOnly: true },
      { cmd: 'deleted', desc: 'Voir les messages supprimés interceptés', usage: '.deleted [nombre|all]', example: '.deleted 30', premium: false, ownerOnly: true },
