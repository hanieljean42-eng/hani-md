...
// qrCallback(qrData) est appelé si le bot demande un scan QR
async function startBotInstance(name, sessionId, ownerJid, qrCallback) {
  ...
  try {
    ...
    sock.ev.on('connection.update', async ({ connection, lastDisconnect, qr }) => {
      // QR code disponible — envoyer via callback
      if (qr && qrCallback) {
